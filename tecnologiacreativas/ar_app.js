...
function init() {
    ...
    let markerControl = new THREEx.ArMarkerControls(arToolkitContext, markerRoot1, {
        ...
        type: 'pattern', patternUrl: 'data/pattern-marcadores.patt',
    });
    ...
    new THREE.MTLLoader()
        .setPath('data/models/')
        .load('azul1.mtl', function (materials) {
            materials.preload();
            new THREE.OBJLoader()
                .setMaterials(materials)
                .setPath('data/models/')
                .load('azul1.obj', function (group) {
    ...
    new THREE.MTLLoader()
        .setPath('data/models/')
        .load('azul2.mtl', function (materials) {
            materials.preload();
            new THREE.OBJLoader()
                .setMaterials(materials)
                .setPath('data/models/')
                .load('azul2.obj', function (group) {
   ...
   new THREE.MTLLoader()
   .setPath('data/models/')
   .load('azul3.mtl', function (materials) {
       materials.preload();
       new THREE.OBJLoader()
           .setMaterials(materials)
           .setPath('data/models/')
           .load('azul3.obj', function (group) {
...
new THREE.MTLLoader()
   .setPath('data/models/')
   .load('negro.mtl', function (materials) {
       materials.preload();
       new THREE.OBJLoader()
           .setMaterials(materials)
           .setPath('data/models/')
           .load('negro.obj', function (group) {
   ...
   new THREE.MTLLoader()
      .setPath('data/models/')
      .load('rosa.mtl', function (materials) {
          materials.preload();
          new THREE.OBJLoader()
              .setMaterials(materials)
              .setPath('data/models/')
              .load('rosa.obj', function (group) {
